export const data = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                task: ["Ismertesse a többfeladatos, többfelhasználós rendszerek működését! ", "Definiálja a klasszikus MVC-alkalmazás felépítését, és térjen ki a skálázhatósági kérdésekre! ", "Jellemezze a virtualizációs szoftverek tulajdonságait! ", "Definiálja a robosztus alkalmazások jellemzőit! ", "Definiálja a csúcsterhelés fogalmát, és magyarázza el ennek költségoldali vonzatát! ", "Tervezzen rendszerarchitektúrát a vázolt probléma megoldására!"],
            ...
            },
            {
                ...
                task: ["Határozza meg a költségkalkuláció elemeit! ", "Ismertesse egy szoftverfejlesztési árajánlat tartalmi és formai elemeire vonatkozó legfontosabb jellemzőket! ", "Mutassa be egy vállalkozói szerződés tartalmi és formai elemeire vonatkozó legfontosabb jellemzőket! I", "smertesse egy szoftverfejlesztésre vonatkozó vállalkozói szerződés speciális tartalmi elemeit!"],
            ...
            {
                id: 13,
                title: "*** Az Ön által vezetett szoftverfejlesztő csapat egy raktárkezelő program elkészítésére kapott megbízást. Tegyen javaslatot az ügyfélnek a fejlesztés során használandó módszertanra! Ismertesse a választása szempontjait!",
                task: ["Ismertesse a szoftverfejlesztés során használható módszertanokat!", "Az egyes módszertanoknak milyen válaszai vannak a felhasználói igények változásának kezelésére?", "Melyik módszertan mekkora mértékű részvételt vár el az ügyféltől?"],
                keys: ["Vízesés modell, „V” modell", "Prototípus fogalma", "Iterációs lépések", "Agilis módszertanok, Scrum"],
                content: ""
            },
            {
                id: 14,
            ...
            {
                id: 17,
                title: "*** Egy ingatlan iroda weboldalát kell megvalósítani. Az oldalon az iroda aktuális hirdetései szerepelnének képekkel, leírásokkal. Tegyen javaslatot a fejlesztési környezet kialakítására!",
                task: ["Határozza meg a kliens és szerver oldali funkcióit! ", "Határozza meg az alkalmazott program nyelvet, keretrendszert!Döntését indokolja! ", "Tegyen javaslatot a kész alkalmazás működtetéséhez szükséges hardver és szoftver környezetre (saját hardver, bérelt eszközök)!"],
                keys: ["HTML5, CSS","Szerver oldali környezet (PHP, JAVA, C#, …stb)","Keretrendszerek (jQuery, AngularJS, … stb.)","Alkalmazás kapcsolata az adatbázissal", "Saját hardver és a bérelt eszközök előnyei, hátrányai"],
                content: ""
            },
            {
                id: 18,
                title: "*** Egy nagykereskedelmi vállalat raktári programját kell kiegészítenie olyan szolgáltatással, hogy a kiskereskedők által használt ügyviteli szoftver le tudja kérdezni az egyes termékekből rendelkezésre álló mennyiséget",
                task: ["Ismertesse az informatikai rendszerek interneten történő egymás közötti kommunikációjának lehetőségeit! ", "Tegyen javaslatot az alkalmazandó módszerre! ", "Határozza meg a működtetéshez szükséges szoftver elemeket! ", "Ismertesse az esetleges kockázatokat, és tegyen javaslatot azok elkerülésére!"],
                keys: ["Web service (SOAP, REST, XML, JSON)", "Web szerver (Apache, IIS, …stb","Titkosítás (egy vagy többkulcsos)"],
                content: ""
            },
            {
                id: 19,
                title: "*** Egy mobil eszközöket árusító üzlet számára készít webshop alkalmazást. Feladat az alkalmazás hátterét biztosító adatbázis megtervezése.",
                task: ["Ismertesse az adatbázis-tervezés alapfogalmait! ", "Mondja el az adatmodellezés alapfogalmait! ", "Vázolja fel a webshop főbb adatbázis-szerkezeti elemeit!"],
                keys: ["Adatbázisok felépítése: táblák, rekordok, mezők. Adatintegritás, adatvédelem. Relációs adatmodell","Elsődleges kulcs fogalma. Index fogalma, indexelés","Adatbázisok normalizálása, optimalizálása. Redundancia csökkentése, megszüntetése","Adatmodellezés: egyed-kapcsolat diagramok, tervezési alapelvek, megszorítások(constraint) modellezése."],
                content: ""
            },
            {
                id: 20,
                title: "*** Egy szállítmányozással foglalkozó cég GPS alapú nyomkövetőkkel látja el a teherautóit. Ezek az eszközök képesek néhány percenként elküldeni az autó helyzetét és néhány főbb jellemzőt egy szerverre. Az Ön feladata annak a webalapú szoftvernek a megtervezése, amely fogadja az adatokat és valós időben megjeleníti a gépkocsik helyzetét",
                task: ["Tervezze meg a rendszer működéséhez szükséges architektúrát! ", "Tervezze meg az adatok tárolásához szükséges adatbázis felépítését! ", "Milyen technológiát használna az adatok fogadására? ", "Hogyan oldaná meg a valós idejű adatok megjelenítését?"],
                keys: ["Adatmodellezés, Mezőtulajdonságok: típusok, mezőméret","Üzenetközvetítő sorok (MQ), Web szerviz (SOAP, REST, XML, JSON)","AJAX"],
                content: ""
            }
        ]
    },
    {
        ...
        items: [
            {
                id: 1,
                title: "Úgy érzi, hogy a munkahelyén használt számítógépe elavult. Írjon e-mailt a felettesének, amiben egy új számítógépet kér! Kérését indokolja és tegyen javaslatot az új gép konfigurációjára!",                task: ["Határozzon meg egy Ön szerint már elavult, és egy korszerű számítógép konfigurációt!", "Ismertesse, hogy miért hatékonyabb dolgozni a korszerűbb géppel!"],

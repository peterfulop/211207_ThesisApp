...
<p>A redundancia<br>- rossz helyfoglal&aacute;s szempontj&aacute;b&oacute;l,<br>- a v&aacute;ltoz&aacute;sok &aacute;tvezet&eacute;s&eacute;t neh&eacute;zkess&eacute; teszi.</p>`,
      },
      {
        ...
        content: `
        <p><strong>konzisztens&nbsp;</strong>: egys&eacute;ges, k&ouml;vetkezetes, belső ellentmod&aacute;sokt&oacute;l mentes<br><strong>inkonzisztens&nbsp;</strong>: ellentmond&oacute;, k&ouml;vetkezetlen</p>
<p><strong><u>A konzisztencia fokozatai</u></strong></p>
<p><strong>Gyenge konzisztencia:</strong><br>A rendszer nem garant&aacute;lja, hogy az &iacute;r&aacute;st k&ouml;vető olvas&aacute;sok a legutolj&aacute;ra be&iacute;rt adatot &eacute;rik el. Az &iacute;r&aacute;s &eacute;s azon pillanat k&ouml;z&ouml;tt eltelt időt, am&iacute;g nem garant&aacute;lhat&oacute;, hogy minden megfigyelő a friss&iacute;tett adatot l&aacute;tja, inkonzisztenciaablaknak (inconsistency window) nevezz&uuml;k.&nbsp;</p>
<p><strong>Fokozatos konzisztencia:</strong><br>A gyenge konzisztencia egyik t&iacute;pusa. A rendszer garant&aacute;lja, hogy ha nincsenek tov&aacute;bbi friss&iacute;t&eacute;sek, előbbut&oacute;bb minden olvas&aacute;s a legut&oacute;bbi &iacute;r&aacute;s &eacute;rt&eacute;k&eacute;t &eacute;ri el.&nbsp;</p>
<p><strong>Erős konzisztencia:</strong><br>Minden olvas&aacute;s művelet az adategys&eacute;gen legut&oacute;bb befejezett &iacute;r&aacute;s művelet eredm&eacute;ny&eacute;vel t&eacute;r vissza, f&uuml;ggetlen&uuml;l att&oacute;l, hogy az adategys&eacute;get melyik csom&oacute;ponton &eacute;ri el.</p>
<p><br></p>
<p><strong>T&ouml;bbfelhaszn&aacute;l&oacute;s k&ouml;rnyezetek</strong></p>
<p>A t&ouml;bbfelhaszn&aacute;l&oacute;s k&ouml;rnyezetben az egyes felhaszn&aacute;l&oacute;k &aacute;ltal v&eacute;grehajtott m&oacute;dos&iacute;t&aacute;sok k&ouml;nnyen inkonzisztens adatb&aacute;zis tartalmat eredm&eacute;nyezhetn&eacute;nek. Ennek elker&uuml;l&eacute;s&eacute;re az adatb&aacute;ziskezelők tranzakci&oacute;kat haszn&aacute;lnak.</p>
<p>&nbsp;<strong>Tranzakci&oacute;k</strong></p>
<p>Az adatb&aacute;zison v&eacute;gzett műveletek logikai egys&eacute;ge. Ahhoz, hogy a m&oacute;dos&iacute;t&aacute;st v&eacute;grehajt&oacute; felhaszn&aacute;l&oacute; kiv&eacute;tel&eacute;vel mindenki az adatb&aacute;zis konzisztens &aacute;llapot&aacute;t l&aacute;ssa, a tranzakci&oacute;k kezel&eacute;se a megold&aacute;s a rel&aacute;ci&oacute;s adatb&aacute;zisokban. Egy tranzakci&oacute; mindig egy konzisztens adatb&aacute;zis &aacute;llapotb&oacute;l indul ki &eacute;s a m&oacute;dos&iacute;t&aacute;sok egy olyan sorozat&aacute;t tartalmazza, melyek v&eacute;g&eacute;n ism&eacute;t egy konzisztens adatb&aacute;zis tartalom &aacute;ll elő. A rel&aacute;ci&oacute;s adatb&aacute;zis kezelők p&aacute;rhuzamosan t&ouml;bb tranzakci&oacute;t is k&eacute;pesek kezelni.</p>
<p>N&eacute;zz&uuml;nk egy egyszerű p&eacute;ld&aacute;t, mely tranzakci&oacute;k n&eacute;lk&uuml;l nehezen lenne kezelhető. Ugyanabban a bankban vezetett k&eacute;t banksz&aacute;mla k&ouml;z&ouml;tt szeretn&eacute;nk utal&aacute;st v&eacute;gezni.Az &quot;A&quot; sz&aacute;ml&aacute;r&oacute;l tegy&uuml;nk &aacute;t 50 fabatk&aacute;nyi &ouml;sszeget a &quot;B&quot; sz&aacute;ml&aacute;ra. M&eacute;g ha egy adatb&aacute;zis t&aacute;bl&aacute;ban t&aacute;roljuk a k&eacute;t sz&aacute;mla egyenleg&eacute;t, akkor sem lehet a feladatot egyetlen SQL utas&iacute;t&aacute;ssal megoldani. Az al&aacute;bbi hat elemi l&eacute;p&eacute;sre bonthatjuk fel a feladatot:</p>
<ol>
    <li>read(A), az A sz&aacute;mla egyenleg&eacute;nek beolvas&aacute;sa</li>
    <li>A := A - 50, az A sz&aacute;mla egyenleg&eacute;nek m&oacute;dos&iacute;t&aacute;sa</li>
    <li>write(B), az A sz&aacute;mla &uacute;j egyenleg&eacute;nek t&aacute;rol&aacute;sa</li>
    <li>read(B), a B sz&aacute;mla egyenleg&eacute;nek beolvas&aacute;sa</li>
    <li>B := B + 50, a B sz&aacute;mla egyenleg&eacute;nek m&oacute;dos&iacute;t&aacute;sa</li>
    <li>write(B), B sz&aacute;mla &uacute;j egyenleg&eacute;nek t&aacute;rol&aacute;sa</li>
</ol>
<p>Az adatb&aacute;ziskezelők azon funkci&oacute;it, melyek a t&ouml;bbfelhaszn&aacute;l&oacute;s k&ouml;rnyezetben biztos&iacute;tj&aacute;k minden felhaszn&aacute;l&oacute; sz&aacute;m&aacute;ra a konzisztens adatb&aacute;zis k&eacute;pet az ACID r&ouml;vid&iacute;t&eacute;ssel jellemzik :<br><strong>Atomicity, Consistency, Isolation, Durability&nbsp;<br>Atomikuss&aacute;g, Konzisztencia, Elszigetelts&eacute;g, &Aacute;lland&oacute;s&aacute;g</strong></p>
<p><strong>Atomikuss&aacute;g (Atomicity):</strong><br>Egy tranzakci&oacute; vagy teljesen lefut, vagy teljesen visszag&ouml;rget&eacute;sre ker&uuml;l. Nincs f&eacute;lig lefutott tranzakci&oacute;. (pl banki &aacute;tutal&aacute;s)</p>
<p><strong>Konzisztencia (Consistency): </strong><br>A tranzakci&oacute; befejez&eacute;se ut&aacute;n az adatb&aacute;zisnak konzisztens &aacute;llapotba kell ker&uuml;lnie.</p>
<p><strong>Elszigetelts&eacute;g (Isolation):</strong><br>A p&aacute;rhuzamosan fut&oacute; tranzakci&oacute;knak egym&aacute;st&oacute;l f&uuml;ggetlen&uuml;l kell műk&ouml;dni&uuml;k. Minden felhaszn&aacute;l&oacute;nak &uacute;gy kell tűnnie mintha csak ő haszn&aacute;ln&aacute; az adatb&aacute;zist. Hat&eacute;konys&aacute;gi okokb&oacute;l nem lehet a f&uuml;ggetlens&eacute;get &uacute;gy biztos&iacute;tani, hogy egyidőben csak egy tranzakci&oacute; futhat az adatb&aacute;zison. Helyette sor illetve t&aacute;bla z&aacute;rol&aacute;sokat alkalmaznak az adatb&aacute;ziskezelők.</p>
<p><strong>&Aacute;lland&oacute;s&aacute;g (Durability):</strong><br>A lez&aacute;rt tranzakci&oacute;k eredm&eacute;nye nem veszhet el. Hat&eacute;konys&aacute;gi okokb&oacute;l az adatb&aacute;ziskezelők nem &iacute;rj&aacute;k r&ouml;gt&ouml;n diszkre a m&oacute;dos&iacute;tott adatokat, hanem mem&oacute;ri&aacute;ban t&aacute;rolj&aacute;k. P&eacute;ld&aacute;ul egy hardver hiba a mem&oacute;ria tartalma &eacute;s &iacute;gy a tranzakci&oacute; eredm&eacute;ny&eacute;nek elveszt&eacute;s&eacute;vel j&aacute;rhatna. Az ilyen adatveszt&eacute;seket az adatb&aacute;ziskezelők tranzakci&oacute; log haszn&aacute;lat&aacute;val oldj&aacute;k meg.</p>
<p><strong>&nbsp;Adatveszt&eacute;s elleni v&eacute;delem</strong></p>
<p>Az adatb&aacute;ziskezelő a tranzakci&oacute; k&ouml;zben v&eacute;grehajtott v&aacute;ltoz&aacute;sokra vonatkoz&oacute; adatokat a tranzakci&oacute; log(ok)ba &iacute;rj&aacute;k ki. A log f&aacute;jlt c&eacute;lszerű egy m&aacute;sik h&aacute;tt&eacute;rt&aacute;rol&oacute;ra tenni mint az adatb&aacute;zis f&aacute;jlokat, hogy az esetleges diszk hib&aacute;k eset&eacute;n ne vesz&iacute;tsuk el mindkettő tartalm&aacute;t. Ezut&aacute;n m&oacute;dos&iacute;tja a tranzakci&oacute; a mem&oacute;ri&aacute;ba bet&ouml;lt&ouml;tt adatb&aacute;zis rekordokat. Az adatb&aacute;ziskezelő a tranzakci&oacute;kt&oacute;l f&uuml;ggetlen logika alapj&aacute;n menti ki a mem&oacute;ri&aacute;b&oacute;l az adatokat (jellemzően k&eacute;sleltetetten). Az adatb&aacute;zis adminisztr&aacute;tor rendszeres időnk&eacute;nt ment&eacute;seket (backup) k&eacute;sz&iacute;t az adatb&aacute;zisf&aacute;jlok tartalm&aacute;r&oacute;l.</p>
<p>&nbsp;Az adatbiztons&aacute;got tov&aacute;bb n&ouml;velhetj&uuml;k a h&aacute;tt&eacute;rt&aacute;rak RAID rendszerbe szervez&eacute;s&eacute;vel illetve redund&aacute;ns adatb&aacute;zis szerverek műk&ouml;dtet&eacute;s&eacute;vel.</p>
        `,
      },
      {
        id: 17,
